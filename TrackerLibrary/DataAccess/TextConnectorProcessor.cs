...
namespace TrackerLibrary.DataAccess.TextHelpers
{
    ...
    public static class TextConnectorProcessor
    {
        ...
        {
            //AppSetting File=< add key = "filePath" value = "E:\NETe\SmartProject\TournamentTracker\PrizeModel.csv"/>
            //file path "E:\NETe\SmartProject\TournamentTracker\PrizeModel.csv"
        ...
        {
            //id,team name.list of ids saparted by the pipe
            //3,Tim's Team,1|3|5
        ...
        public static void SaveMatchupToFile(this MatchupModel matchup, string matchupFile, string matchupEntryFile)
        {
            ...
            ////id=0,entries=1,(pipe deimited by id), winner=2,matchupRound=3
        ...
        public static List<TournamentModel> ConvertToTournamntModels(this List<string> lines, string teamFileName, string peopleFileName, string PrizeFileName)
        {
